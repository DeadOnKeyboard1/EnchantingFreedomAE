...
namespace EnchantingFreedom
{
	...
	void Config::Load()
	{
		...
		try {
			...
			ReadBool(path_, kSettingsSection, L"AllowDisenchantKnownEnchantments", settings_.allowDisenchantKnownEnchantments);
			ReadBool(path_, kSettingsSection, L"AllowDisenchantCreatedEnchantments", settings_.allowDisenchantCreatedEnchantments);
			ReadBool(path_, kSettingsSection, L"AllowStaves", settings_.allowStaves);
			ReadBool(path_, kSettingsSection, L"AllowNonPlayableItems", settings_.allowNonPlayableItems);
			ReadBool(path_, kSettingsSection, L"AllowQuestItems", settings_.allowQuestItems);
			ReadBool(path_, kSettingsSection, L"RefreshOnCraftingMenuOpen", settings_.refreshOnCraftingMenuOpen);
		...
		SKSE::log::info(
			"Configuration: slots={} max={} enchantingRestrictions={} disenchantingRestrictions={} knownDisenchant={} createdDisenchant={} staves={} nonPlayable={} questItems={} refreshOnCraftingMenuOpen={}",
			settings_.enableSlotLimit,
			settings_.maximumEnchantments,
			settings_.removeEnchantingRestrictions,
			settings_.removeDisenchantingRestrictions,
			settings_.allowDisenchantKnownEnchantments,
			settings_.allowDisenchantCreatedEnchantments,
			settings_.allowStaves,
			settings_.allowNonPlayableItems,
			settings_.allowQuestItems,
			settings_.refreshOnCraftingMenuOpen);
	}
